...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            blockquote,dd,dl,figure,h1,h2,h3,h4,h5,h6,hr,p,pre{margin:0}fieldset{margin:0;padding:0}
            legend{padding:0}menu,ol,ul{list-style:none;margin:0;padding:0}dialog{padding:0}
            textarea{resize:vertical}input::placeholder,textarea::placeholder{opacity:1;color:#9ca3af}[role=button],
            button{cursor:pointer}:disabled{cursor:default}audio,canvas,embed,iframe,img,object,svg,video{display:block;vertical-align:middle}
    ...
    <div class="font-sans antialiased h-screen flex flex-col justify-center items-center">
            <div class="flex justify-center mt-4 mb-4">    
                <svg class="h-15 w-auto" viewBox="0 0 62 65" xmlns="http://www.w3.org/2000/svg" fill="#000000" width="150px" height="150px" role="img">
