                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('action.update_transaction', $transaction->id) }}" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" step="0.01" name="balance" id="balance" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ number_format((float)$transaction->balance, 2) }}" readonly>
                        </div>
